      ...
      <div className='header-col-2'>
        {
          ...
          ? <div className='profile-icon-con'>
            <img style={{height:'30px', width:'30px', borderRadius: '50%'}} className='profile-img' src='../src/assets/profile-img-Ade-o.png' alt="" />
            <div 
            ...
            <img 
             ...
             className='profile-arrow' src='../src/assets/caret-down-fill.svg' alt="" 
             onMouseOver={ ()=> setDropDown('profile-dropdown')}
             onMouseOut={()=> setDropDown('hidden')}
             />
