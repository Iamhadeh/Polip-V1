  ...
  return (
    <div className='about-us-sec-con'>
        ...
        <div className="col-2-about-us-sec">
            <h2>About Polip</h2>
            <p>Polip is a community-driven platform for people with skills to meet, share ideas and start building.</p>
            ...
            <p>Polip gives people the chance to build something <span>useful</span> instead of waiting</p>
        </div>
    </div>
  )
}
